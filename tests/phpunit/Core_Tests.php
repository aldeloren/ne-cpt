...
use TenUp\A1D_Northeastern_CPT as Base;
...
class Core_Tests extends Base\TestCase {
	...
	public function test_i18n() {
		...
		\WP_Mock::onFilter( 'plugin_locale' )->with( 'en_US', 'a1dnecpt' )->reply( 'en_US' );
		\WP_Mock::wpFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'a1dnecpt', 'lang_dir/a1dnecpt/a1dnecpt-en_US.mo' ),
		) );
		...
		\WP_Mock::wpFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'a1dnecpt', false, 'path/languages/' ),
		) );
	...
	public function test_init() {
		// Setup
		\WP_Mock::expectAction( 'a1dnecpt_init' );
