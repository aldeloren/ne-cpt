...
<ul class="a1dnecpt_event_meta">
  <li><label for="a1dnecpt_event_start_date">Event Start Time:</label><input name="a1dnecpt_event_start_date" type="date" class="a1dnecpt_input_date" value="<? echo $formatted_start_date; ?>"></li>
  <li><label for="a1dnecpt_event_start_time">Event Start Time:</label><input name="a1dnecpt_event_start_time" type="time" class="a1dnecpt_input_time" value="<? echo $formatted_start_time; ?>"></li>
 <li><label for="a1dnecpt_event_end_date">Event end Time:</label><input name="a1dnecpt_event_end_date" type="date" class="a1dnecpt_input_date" value="<? echo $formatted_end_date; ?>"></li>
  <li><label for="a1dnecpt_event_end_time">Event end Time:</label><input name="a1dnecpt_event_end_time" type="time" class="a1dnecpt_input_time" value="<? echo $formatted_end_time; ?>"></li>
